								...
								<div class="card-body">
									<form action="proses_ubah.php?id=<?php echo $siswa['id'] ?>" method="POST">
										<div class="form-group">
											<label for="npm">NPM Siswa </label>
											<div class="input-group">
												<div class="input-group-prepend">
													<div class="input-group-text">#</div>
												</div>
												<input type="number" id="npm" class="form-control" placeholder="Masukan NPM" name="npm" autocomplete="off" required="required" value="<?php echo $siswa['npm'] ?>">
											</div>
										</div>
										<div class="form-group">
