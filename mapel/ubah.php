...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Ubah Data Mata Kuliah</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Ubah Data Mata Kuliah</h1>
									...
									<form action="proses_ubah.php?id=<?php echo $mapel['id'] ?>" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_mapel" class="form-control" placeholder="Masukan Mata Kuliah" name="nama_mapel" autocomplete="off" required="required" value="<?php echo $mapel['mapel'] ?>">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="guru_pengampu">Dosen </label>
											<div class="input-group">
												<div class="input-group-prepend">
													<div class="input-group-text"><i class="fas fa-user"></i></div>
												</div>
												<input type="text" id="guru_pengampu" class="form-control" placeholder="Masukan Dosen" name="guru_pengampu" autocomplete="off" required="required" value="<?php echo $mapel['guru_pengampu'] ?>">
											</div>
										</div>
										<div class="form-group">
