...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Mata Kuliah</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Tambah Data Mata Kuliah</h1>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_mapel" class="form-control" placeholder="Masukan Mata Kuliah" name="nama_mapel" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="guru_pengampu" class="form-control" placeholder="Masukan Dosen" name="guru_pengampu" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
